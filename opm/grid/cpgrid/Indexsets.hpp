    ...
    namespace cpgrid
    {
        ...
        public:
            ...
            IndexType subIndex(const cpgrid::Entity<0>& e, int i, unsigned int cc) const
            {
                ...
                default: OPM_THROW(std::runtime_error, "Codimension " + std::to_string(cc) + " not supported.");
                }
        ...
        public:
            ...
            IdType subId(const cpgrid::Entity<0>& e, int i, int cc) const
            {
                ...
                default: OPM_THROW(std::runtime_error, "Cannot get subId of codimension " + std::to_string(cc));
                }
                return -1;
            }
        private:
